document.addEventListener("DOMContentLoaded", function () {
    ...
    const jogos = document.querySelectorAll(".coluna-jogo");
    ...
    let cards = Array.from(document.querySelectorAll(".coluna-jogo"));
    const selectOrdenar = document.getElementById("ordenar-jogos");
    const salvar = "jogosFavoritos";
